...
-- depends_on: {{ ref('draft_orders_line_items') }}
{{ unnest_cte(ref('draft_orders_line_items'), 'line_items', 'properties') }}
select
...
from {{ ref('draft_orders_line_items') }} as table_alias
-- properties at draft_orders/line_items/properties
