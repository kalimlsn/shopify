...
{{ unnest_cte(ref('draft_orders_scd'), 'draft_orders', 'note_attributes') }}
select
...
-- note_attributes at draft_orders/note_attributes
{{ cross_join_unnest('draft_orders', 'note_attributes') }}
where 1 = 1
