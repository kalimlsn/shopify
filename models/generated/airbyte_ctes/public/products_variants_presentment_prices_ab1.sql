...
-- depends_on: {{ ref('products_variants') }}
{{ unnest_cte(ref('products_variants'), 'variants', 'presentment_prices') }}
select
...
from {{ ref('products_variants') }} as table_alias
-- presentment_prices at products/variants/presentment_prices
